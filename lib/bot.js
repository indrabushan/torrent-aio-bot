...
const searchRegex = /\/find (piratebay|limetorrent|1337x) (.+)/;
const detailsRegex = /\/details (piratebay|limetorrent|1337x) (.+)/;
const downloadRegex = /\/seed (.+)/;
const statusRegex = /\/list (.+)/;
...
/Find {site} {query} - To search for torrents
query is what you want to search for
eg. 
    /Find piratebay Chernobyl
    /Find piratebay Chernobyl 720p
    /Find 1337x Lust Stories
